...
}()); var now = -1; var resLength = 0; var thisSearch = 'https://bing.com/search?q='; var thisSearchIcon = './static/ping.svg'; var storage = window.localStorage; if (!storage.stopHot) { storage.stopHot = true }
...
$(function () {
    var search = { 
        data: [
          { 
            name: 'Bing', 
            img: './static/images/bing.svg', 
            url: 'https://bing.com/search?q=' 
          }, 
          { 
            name: 'Google', 
            img: './static/images/google.svg', 
          ...
          { 
            name: '知乎', 
            img: './static/images/zhihu.svg', 
            url: 'https://www.zhihu.com/search?type=content&q=' 
          },
          { 
            name: '豆瓣', 
            img: './static/images/douban.svg', 
            url: 'https://www.douban.com/search?source=suggest&q=' 
          },
          { 
            name: '哔哩哔哩', 
            img: './static/images/bilibili.svg', 
            url: 'https://search.bilibili.com/all?keyword=' 
          },
          { 
            name: 'DeepL', 
            img: './static/images/deepl.svg', 
            url: 'https://www.deepl.com/translator#en/zh/' 
          },
          { 
            name: 'PubMed', 
            img: './static/images/pubmed.svg', 
